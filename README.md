...
| Gabriel Hewitt | Water Calculator | A web app that estimates the user's daily water intake based multiple factors | Dehydrated users | [Github](https://github.com/ghewitt95/water-calculator) | [Render](https://water-caluculator.onrender.com/) |