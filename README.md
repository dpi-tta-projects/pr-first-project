...
| Drew Krehel | Japanese Literal Translation App  | Translate user input into the different levels of translation possible between the Japanese and English language. | People learning Japanese | [Github](https://github.com/DrewKrehel/sinatra-literaltranslation-app) | [Link](https://literaltranslation-app.onrender.com/) |
...
| Berhane Berhane | Tori | Web app tool to calculate weekly food orders based on current usage | Fast Food Restauraunts/Small Businesses | [Github](https://github.com/bberhane80/tori.git) | [Render](https://my-app-name-466a.onrender.com/) |